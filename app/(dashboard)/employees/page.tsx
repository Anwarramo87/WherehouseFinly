...
export default function EmployeesPage() {
  ...
  const handleSaveEmployee = async (formData: AddEmployeeFormData) => {
    ...
    // تجهيز الـ Payload الصافي (10 حقول فقط + monthlySalary) - تم مسح email و hourlyRate و profession
    const payload: EmployeeUpsertPayload = {
      ...
      scheduledStart: formData.scheduledStart,
      scheduledEnd: formData.scheduledEnd,
      monthlySalary: toNumber(formData.monthlySalary), // إرسال الراتب الشهري كما هو
    };
