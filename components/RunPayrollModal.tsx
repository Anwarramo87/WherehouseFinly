            ...
            <div className="space-y-3">
              ...
              <label className="flex items-start gap-3 p-3 bg-[#C89355]/5 border border-[#C89355]/15 rounded-xl cursor-pointer hover:bg-[#C89355]/10 transition-all group">
                ...
                <div className="flex-1">
                  <div className="text-sm font-bold text-[#C89355] group-hover:text-[#d0b468] transition-colors">خصومات الدوام</div>
                  <div className="text-[11px] text-slate-400 font-semibold mt-0.5">الغياب والتأخير (يتم حسابها تلقائياً من سجلات الحضور)</div>
                </div>
              </label>
              ...
              <label className="flex items-start gap-3 p-3 bg-[#C89355]/5 border border-[#C89355]/15 rounded-xl cursor-pointer hover:bg-[#C89355]/10 transition-all group">
                ...
                />
                <div className="flex-1">
                  <div className="text-sm font-bold text-[#C89355] group-hover:text-[#d0b468] transition-colors">خصومات النقل</div>
                  <div className="text-[11px] text-slate-400 font-semibold mt-0.5">تكاليف الحافلات (يتم اقتطاعها من الراتب)</div>
                </div>
              </label>
            </div>
