...
// import { useState, useEffect, useRef, useCallback } from "react";
// import { createPortal } from "react-dom";
// // تم إزالة CalendarHeart واستخدام Calendar لضمان عدم حدوث أي خطأ
// import { X, Loader2, Save, UserCog, Phone, User, Briefcase, ChevronRight, ChevronLeft, CalendarDays, Coins, Users, UserCircle, Calendar } from "lucide-react";
// import { toast } from "react-hot-toast";
// import { useRoles } from "@/hooks/useRoles";
// import useDepartments from '@/hooks/useDepartments';
// import type { Employee } from "@/types/employee";
...
//       // 🌟 حساب العمر الدقيق (بالأشهر والأيام والسنوات) 🌟
...
//               {/* 🌟 حقل تاريخ الميلاد بالتصميم الداكن 🌟 */}
//               <div>
//                 <label className="block text-sm font-bold text-[#C89355] mb-2">تاريخ الميلاد</label>
//                 <div className="relative group">
//                   <input
